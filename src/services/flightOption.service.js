...
const { SearchFlightOptionsSchema } = require("../schemas/flightOption.schema");
const { fetchFlightOptions } = require("../infrastructure/googleSearch");

const generateFlightOptions = async (prompt) => {
  const instructions = `
  ...
  return await fetchFlightOptions(response.query);
};
